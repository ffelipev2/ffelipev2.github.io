...
try {
    for (const file of ['js/hero-3d.js', 'js/hero/scene.js', 'js/hero/camera-rig.js', 'js/hero/animation-sequence.js', 'js/hero/narrative-effects.js', 'scripts/build-hero.mjs']) {
